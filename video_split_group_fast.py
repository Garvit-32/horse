...
def process_video(tensor_file_path: str):
    ...
    try:
        ...
        for frm_idx in needed_frame_indices:
            ...
            if orientation_kp in ["left", "right"]:
        ...
        # try:
        print("recent_preds",recent_preds)
        possible_orientations = ['left', 'right', 'front', 'back']
        # print("current_pred",current_pred)
        smoothed_orientation = split_orientations(recent_preds,possible_orientations)
        print("smoothed_orientation",smoothed_orientation)
